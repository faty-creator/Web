...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Styles existants de affectation.jsp inchangés */
        .student-container {
            max-width: 1200px;
            margin: 2rem auto;
            padding: 0 1rem;
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="../Route?page=list" class="menu-item">
                <i class="bi bi-people-fill menu-icon"></i>
                <span class="menu-text">Gestion des Étudiants</span>
                <i class="bi bi-chevron-right menu-arrow"></i>
            </a>
            
            <a href="../Route?page=listAffectation" class="menu-item active">
    ...
    <div class="main-content">
        ...
        <div class="student-container">
            <div class="student-header">
                ...
                <a href="../Route?page=formAffectation" class="add-btn">
